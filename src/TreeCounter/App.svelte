                    ...
                    <div class="logoPlanet">
                        ...
                        {:else}
                            <svg
                                ...
                                x="0px"
                                y="0px"
                                viewBox="0 0 384.9 387.1"
                                style="enable-background:new 0 0 384.9 387.1;"
                                xml:space="preserve"
                                ><style type="text/css">
                                    .st0 {
                                        fill: #2f3336;
